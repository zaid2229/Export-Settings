frappe.ui.form.on('Data Export', {
    onload: function(frm) {
        ...
        var customButton = '<button class="btn btn-xs btn-default" id="my-custom-button">Export Settings</button>';
        $('.frappe-control[data-fieldname="unselect_all"]').after(customButton);

        // Add click event for your custom button
        $(document).on('click', '#my-custom-button', function() {
            // Call your custom method or perform any action here
